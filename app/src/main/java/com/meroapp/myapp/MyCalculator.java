...
public class MyCalculator extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView txt;
    Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnsum, btnsub, btnmulti, btndiv, btnper, btnequal, btnclear;
    String txtget, first, second, output, result;
        ...
        switch (v.getId()) {
            ...
            case R.id.btnequal:
                if (txt.getText().toString() != null && !first.equals("")) {
                    ...
                    result = calculate(first, second, output);
                    txt.setText(result);
                }
                break;
    ...
    public String calculate(String first, String second, String output) {
        switch (txtget) {
